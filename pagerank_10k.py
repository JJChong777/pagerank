...
def generate_large_graph_visuals(pr_scores, errors, node_list):
    """Generates the three graphs for the 10k dataset."""
    ...
    ax1.set_title('L1 Error Convergence (10k Nodes)', fontsize=13, fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig('pagerank_10k_analysis.png', dpi=150, bbox_inches='tight')
    plt.close()
    print("Saved graphs as: pagerank_10k_analysis.png")
...
if __name__ == "__main__":
    try:
        ...
        print(f"\nFinal L1 Error between methods on 10k dataset: {l1_error:.4e}")
